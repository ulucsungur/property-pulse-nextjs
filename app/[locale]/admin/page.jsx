...
// 1. IMPORT: Çeviri kancası
import { useTranslations } from 'next-intl';

// Grafikleri Dinamik Import
const AdminCharts = dynamic(() => import("./Charts"), {
    ssr: false,
    // Not: Burası component dışı olduğu için çeviri kancası çalışmaz,
    // ya statik bırakırız ya da sadece ikon koyarız. Basitlik adına statik/ikon bıraktım.
    loading: () => (
...
export default function AdminDashboard() {
    ...
    return (
        <div className="space-y-8 pb-10 mt-16">
...
// Kart Bileşeni (Aynı kalıyor, props ile veri alıyor)
