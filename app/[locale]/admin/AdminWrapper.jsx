...
// 1. DEĞİŞİKLİK: Link'i utils/navigation'dan çekiyoruz
            ...
            <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                >
                    ...
                    <nav className="p-4 space-y-1 overflow-y-auto h-[calc(100%-64px)]">
                        {/* Çeviriler: t('dashboard'), t('ads') ... */}
                        <SidebarLink href="/admin" icon="📊" label={t('dashboard')} onClick={() => setIsMobileMenuOpen(false)} />
                        <SidebarLink href="/admin/properties" icon="🏠" label={t('ads')} onClick={() => setIsMobileMenuOpen(false)} />
                        ...
                        <div className="pt-4 mt-4 border-t border-slate-800">
                            ...
                            <Link href="/" className="flex items-center space-x-3 px-4 py-3 rounded text-sm text-slate-400 hover:bg-slate-800 hover:text-white transition">
                                <span>⬅️</span> <span>{t('backToSite')}</span>
                            </Link>
                        </div>
                    </nav>
                </aside>
                ...
                <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                    ...
                    <header className="md:hidden flex items-center justify-between px-4 h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-[9997]">
                        ...
                        {/* Çeviri: Mobil Başlık */}
                        <span className="font-semibold text-gray-800 dark:text-white text-sm tracking-wide">
                            {t('mobileTitle')}
                        </span>
...
// Sidebar Link (Link bileşeni yukarıdan otomatik olarak i18n uyumlu geldiği için burası çalışır)
