            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                    ...
                    {PROPERTY_TYPES.map((type) => (
                        <Link
                            key={type.value}
                            // URL yine İngilizce kalır (SEO ve filtreleme için iyidir) -> ?type=Apartment
                        ...
                        >
                            ...
                            {/* 2. DEĞİŞİKLİK: type.label yerine t(type.value) */}
                            {/* type.value = "Apartment" ise, JSON'dan "Daire"yi getirir */}
                    ...
                    >
                        {/* 3. DEĞİŞİKLİK: Sabit metin yerine çeviri */}
                        {t('ViewAll')}
                    </Link>
                </div>
            </div>
