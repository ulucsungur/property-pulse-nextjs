            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <form action={formAction}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            className="bg-white dark:bg-gray-700 dark:text-white  shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="name"
                            name="name"
                            type="text"
                    ...
                    <div className="mb-4">
                        ...
                        <textarea
                            className="bg-white dark:bg-gray-700 dark:text-white shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 h-44 focus:outline-none focus:shadow-outline"
                            id="message"
                            name="message"
