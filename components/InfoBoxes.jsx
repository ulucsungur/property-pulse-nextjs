...
// ÖNEMLİ: Link'i kendi oluşturduğumuz navigation dosyasından çekiyoruz
import { Link } from '@/utils/navigation';

const InfoBoxes = () => {
    // JSON dosyasındaki 'InfoBoxes' başlığını kullanacağımızı belirtiyoruz
        ...
        <section>
            <div className="container-xl lg:container m-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-lg">
                    ...
                    {/* KUTU 1: Kiracılar (Soldan Gelsin) */}
                    <motion.div
                    ...
                    {/* KUTU 2: Ev Sahipleri (Sağdan Gelsin) */}
                    <motion.div
